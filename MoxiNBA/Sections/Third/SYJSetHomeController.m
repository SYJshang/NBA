...
@interface SYJSetHomeController ()<UICollectionViewDataSource, SYJCollectionFlowLayoutDelegate,UICollectionViewDelegate>
...
@implementation SYJSetHomeController
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:cell.lotteryName.text forKey:@"home"];
    
    UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"hint" message:[NSString stringWithFormat:@"You choose the home team: %@",cell.lotteryName.text] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil];
    [alert show];
