...
@interface SYJPlayerDataController (){
...
@implementation SYJPlayerDataController
...
- (void)getHomeNetWorkData{
    ...
    [SYJHttpHelper GET:[NSString stringWithFormat:@"http://api.suredbits.com/nba/v0/stats/%@/%@",self.playerID.playerId,self.model.gameId] parameters:nil success:^(id responseObject) {
...
//        [self.tableView reloadData];
        SYJPlayerDataModel *model = [SYJPlayerDataModel mj_objectWithKeyValues:dict];
